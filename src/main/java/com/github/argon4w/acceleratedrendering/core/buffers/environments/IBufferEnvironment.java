...
public interface IBufferEnvironment {
    ...
    class Presets {
        ...
        // Marking as non-final to fix errors
        public static IBufferEnvironment BLOCK = new VanillaBufferEnvironment(DefaultVertexFormat.BLOCK, ComputeShaderPrograms.CORE_BLOCK_MESH_UPLOADING_KEY, ComputeShaderPrograms.CORE_BLOCK_VERTEX_TRANSFORM_KEY);
        public static IBufferEnvironment ENTITY = new VanillaBufferEnvironment(DefaultVertexFormat.NEW_ENTITY, ComputeShaderPrograms.CORE_ENTITY_MESH_UPLOADING_KEY, ComputeShaderPrograms.CORE_ENTITY_VERTEX_TRANSFORM_KEY);
        public static IBufferEnvironment POS_COLOR_TEX_LIGHT = new VanillaBufferEnvironment(DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, ComputeShaderPrograms.CORE_POS_COLOR_TEX_LIGHT_MESH_UPLOADING_KEY, ComputeShaderPrograms.CORE_POS_COLOR_TEX_LIGHT_VERTEX_TRANSFORM_KEY);
    }
}
